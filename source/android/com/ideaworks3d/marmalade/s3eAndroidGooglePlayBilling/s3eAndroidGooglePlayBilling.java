...
class s3eAndroidGooglePlayBilling
{
    ...
    public static class S3eBillingItemInfo
    {
        ...
        public String m_Price_Amount_Micros;
        public String m_Price_Currency_Code;
        ...
        public S3eBillingItemInfo(SkuDetails s)
        {
            ...
            m_Type = s.getType();
            m_Price = s.getPrice();
            m_Price_Amount_Micros = s.getPriceAmountMicros();
            m_Price_Currency_Code = s.getPriceCurrencyCode();
            m_Title = s.getTitle();
